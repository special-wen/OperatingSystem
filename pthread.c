...
{     
    ...
    {       
        ...
        /*
        if(i == 0){
        pthread_create(&pthread_id[i],NULL,thread_worker,(void*)(&zero));}
        else if(i == 1){
        pthread_create(&pthread_id[i],NULL,thread_worker,(void*)(&one));}
        else{

        pthread_create(&pthread_id[i],NULL,thread_worker,(void*)(&two));}
        //usleep(1000);
        */
